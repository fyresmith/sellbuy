...
<div class="container mt-5 d-flex justify-content-center card-container">
  <div class="card border card-fade" style="width: 40rem">
    <div class="card-body d-flex flex-column align-items-center">
      ...
      <form action="<%= Util.webPage("init-loader") %>" id="form">
        <div class="row my-4">
          <div class="col-md-6">
        ...
        <div class="container d-flex justify-content-center">
          <button type="button" onclick="generateDatabase()" id="submitBtn" class="btn btn-primary">Generate Database</button>
        </div>
      </form>
    </div>
  </div>

  <div class="card border loading-card" id="loadingCard" style="width: 40rem; display: none;">
    <div class="card-body d-flex flex-column align-items-center">
      <h3 class="card-title text-center fw-bold">Loading...</h3>
      <my-precious color="black"></my-precious>
          <img width="150" height="150" src="<%= Util.webPage("image/loader.gif") %>" />
      <p>Please wait while the database is being generated.</p>
      <!-- You can add any additional loading content here -->
    </div>
  </div>
</div>
</body>
...
<script>
  function generateDatabase() {
    ...
    // You may want to submit the form after a certain delay or after completing an asynchronous operation
    form.submit();
  }
</script>
