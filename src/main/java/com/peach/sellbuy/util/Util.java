...
import com.peach.sellbuy.business.Review;
...
public class Util {
    ...
    public static String getBaseURL(String url) {
        try {
            ...
            return "http://localhost:8080/SellBuy-1.0/";
        }
    }

    public static String webPage(String page) {
        return "http://localhost:8080/SellBuy-1.0/" + page;
    }

    public static String search(String query) {
        return "http://localhost:8080/SellBuy-1.0/search?searchBar=" + query;
    }
